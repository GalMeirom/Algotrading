...
from strategies import Weather_BH
import math
import datetime
import pandas as pd
import numpy as np
...
class Backtest:
    ...
    def backtest(self):
            ...
            l = np.unique(stocks_data['t0'].to_numpy()) 
            ...
            for i in l:
                ...
                records_data.loc[i, "Date"] = curr_stocks_data.loc[0,'Date']
                ...
                for j in range(0, 3):
                    ...
                    if position is None:
                        ...
                        if i == max(l):
                            continue
                        instruction: BrokerInstruction = self.strategy.strategies[j].enter_position(curr_sector_stocks_data)
                        ...
                        if i == max(l):
                            ...
                            instruction = self.strategy.strategies[j].exit_position(curr_sector_stocks_data, position)
